...
function ciclo(){
    ...
    contador = 0;
    contexto.clearRect(0,0,lienzo.clientWidth,lienzo.height);
    ...
    if(vibora.celdas.lengt>vibora.maxCeldas){
        vibora.celdas.pop();
    }
    ...
    vibora.celdas.forEach(function(cell,index){
        ...
        if(cell.x === comida.x && cell.y === comida.y){
            vibora.maxCeldas++;
            comida.x= getRandomInt(0,25)* cuadricula;
            comida.y= getRandomInt(0,25)* cuadricula;
        }
